(async function() {
  ...
  const componentLoaders = [
    
    {
      ...
      loader: async () => {
        try {
          const module = await import('/docs-islands/assets/Landing.CDXyl5pH.js');
    ...
    },
    {
      ...
      loader: async () => {
        try {
          const module = await import('/docs-islands/assets/ReactComp1.BMxtl_QH.js');
    ...
    },
    {
      ...
      loader: async () => {
        try {
          const module = await import('/docs-islands/assets/ReactComp3.bzk1Ohq6.js');
          return module.default;
        } catch (error) {
    ...
    },
    {
      ...
      loader: async () => {
        try {
          const module = await import('/docs-islands/assets/ReactComp4.CoMpYBxI.js');
    ...
    },
    {
      ...
      loader: async () => {
        try {
          const module = await import('/docs-islands/assets/ReactVueSharedComp.DnenCgn1.js');
          return module.default;
        } catch (error) {
